library(holepunch)
write_compendium_description(package = "biner présentation", 
                             description = "biner is a powerfull tools for making
                             reproductible code, and allow people to interact to your work")
# to write a description, with dependencies listed 
# It's good practice to now go fill in the placeholder text.

write_dockerfile(maintainer = "Tra Bi Nene") 
